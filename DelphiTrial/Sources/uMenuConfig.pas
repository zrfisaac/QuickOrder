...
begin
  ...
  begin
    try
      DataMain.fdtClient.Close;
      DataMain.fdtProduct.Close;
      ...
      begin
        ...
        Params.Values['ODBCAdvanced'] := 'TrustServerCertificate=yes';
        Open;
      end;
      DataMain.fdtClient.Open;
      DataMain.fdtProduct.Open;
      //DataMain.fdtOrder.Open;
    except
      on E: Exception do
      begin
        MessageBox(
